...
class createBlop(FlaskForm):
    blop = TextAreaField('What is on your mind?',validators=[DataRequired(),Length(max=500)])
    blop_img = FileField('Include Image',validators=[FileAllowed(['jpg','png'])])
    submit = SubmitField('Blop')
